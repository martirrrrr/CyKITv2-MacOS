...
class EEG(object):
    ...
    def Setup(self, model, config):
        ...
        avail_hid_devices = hid.find_all_hid_devices() if os.name == 'nt' else hid.device()
	print(avail_)
        ...
        for device in avail_hid_devices:
            ...
            if os.name == 'nt':
                ...
                instance_id = device.instance_id
                 ...
                 print("AVAILABLE DEVICES DETECTED:")
                 keys = list(device.keys())
                 keys.sort()
                 for key in keys:
                     print("%s : %s" % (key, device[key]))
                 print()
                 print("Remember vendor/prod id of your desired one.")
